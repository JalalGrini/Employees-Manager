    ...
    <div class="row g-4">
        <div class="col-lg-4 col-md-6">
            <div class="card animate__animated animate__fadeInUp">
                ...
                <div class="card-body">
                    ...
                    <p class="display-5 fw-bold" style="color: var(--primary-navy);">{{$teammembers}}</p>
                    <a href="/team-members" class="btn btn-primary">View Team</a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                ...
                <div class="card-body">
                    <h5>Incompleted docs</h5>
                    <p class="display-5 fw-bold" style="color: var(--primary-navy);">{{$documentreqs}}</p>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                <div class="card-header">
                    <i class="fas fa-calendar"></i>Leaves
                </div>
                <div class="card-body">
                    <h5>Pending Leaves</h5>
                    <p class="display-5 fw-bold" style="color: var(--primary-navy);">{{$leavereqs}}</p>
                    <a href="/leaves" class="btn btn-primary">Manage Leaves</a>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    @foreach ( $news as $new)
                        <div class="update-item">
                            ...
                            <div>
                                <h6>{{$new['title']}}</h6>
                                <p class="text-muted small">{{ \Carbon\Carbon::parse($new->published_at)->format('M d, Y H:i') }}</p>
                            </div>
                        </div>
                    @endforeach
                    <a href="/allnewsemp" class="btn btn-primary mt-3">View All news</a>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
